    ...
    <>
      <div className="h-[40vh] md:h-[50vh] relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <h1 className="text-fluid-h1 font-serif text-white">Our Story</h1>
        </div>
      </div>
      ...
      <Section>
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="prose prose-base md:prose-lg text-muted-foreground mx-auto">
            <p className="text-xl md:text-2xl font-serif text-foreground leading-relaxed text-center mb-8 md:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-border">
            <div className="text-center">
              <h3 className="text-4xl md:text-5xl font-serif text-primary mb-2">10+</h3>
              <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-muted-foreground">Modalities</p>
            </div>
            <div className="text-center">
              <h3 className="text-4xl md:text-5xl font-serif text-primary mb-2">1000+</h3>
              <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-muted-foreground">Clients Served</p>
            </div>
            <div className="text-center">
              <h3 className="text-4xl md:text-5xl font-serif text-primary mb-2">100%</h3>
              <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-muted-foreground">Personalized</p>
            </div>
          </div>
        </div>
      </Section>
