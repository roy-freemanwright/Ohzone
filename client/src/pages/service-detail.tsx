...
export default function ServiceDetail() {
  ...
  return (
    <>
      <div className="pt-24 pb-12 md:pt-32 md:pb-16 bg-muted/30 border-b border-border/50 overflow-hidden">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="relative rounded-2xl lg:rounded-none overflow-hidden aspect-video lg:aspect-square xl:aspect-[4/3] order-1 lg:order-2 lg:-mr-6 xl:-mr-12">
              <img 
                src={serviceImage} 
                alt={service.name}
                className="w-full h-full object-cover lg:object-center [mask-image:none] lg:[mask-image:linear-gradient(to_right,transparent_0%,transparent_10%,black_70%)] [-webkit-mask-image:none] lg:[-webkit-mask-image:linear-gradient(to_right,transparent_0%,transparent_10%,black_70%)]"
              />
            </div>
          </div>
        </div>
