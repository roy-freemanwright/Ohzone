    ...
    <>
      <div className="relative min-h-[50vh] md:h-[60vh] flex items-center justify-center overflow-hidden bg-slate-950">
        ...
        <div className="container relative z-10 text-center px-4 md:px-6 py-20">
          ...
          <h1 className="text-fluid-h1 font-serif text-white mb-4 md:mb-6">Detox Protocol</h1>
      ...
      <Section>
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
          <h2 className="text-fluid-h2 font-serif mb-4 md:mb-6">Why our Detox Protocol?</h2>
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed">
            Standard detoxes often fail because they don't address drainage pathways first. Our approach helps bind and remove toxins while supporting the mitochondria for sustained energy.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-muted-foreground mb-6 text-sm md:text-base">
              We recommend working with our practitioners to tailor the detox protocol to your specific needs.
            </p>
