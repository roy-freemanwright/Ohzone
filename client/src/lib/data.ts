export type ServiceCategory = "Clinic" | "Medical" | "Aesthetics" | "Regenerative";
...
export const goals: Goal[] = [
  {
    id: "detox",
    title: "Detox & Reset",
    description: "Clear toxins and refresh your system.",
    slug: "detox-reset",
  ...
  },
  {
    ...
    description: "Targeted therapies for inflammation and injury.",
    slug: "pain-relief",
  ...
  },
  {
    ...
    description: "Boost cellular energy and mental clarity.",
  ...
  },
  {
    ...
    description: "Advanced protocols for anti-aging and vitality.",
    slug: "longevity",
  ...
  },
  {
    ...
    description: "Rejuvenate your natural glow.",
  ...
  },
  {
    ...
    description: "Support healthy metabolism and weight goals.",
